...
#include <jni.h>
/* Header for class nodes_utils_external_ImageFeatures */

#ifndef _Included_nodes_utils_external_ImageFeatures
#define _Included_nodes_utils_external_ImageFeatures
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     nodes_utils_external_ImageFeatures
 * Method:    getSIFTs
 * Signature: (IIIII[F)[S
 */
