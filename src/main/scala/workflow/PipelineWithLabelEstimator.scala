 ...
 */
private[workflow] case class PipelineWithLabelEstimator[A, B : ClassTag, C : ClassTag, L] (pipeline: Pipeline[A, B], estimator: LabelEstimator[B, C, L]) extends LabelEstimator[A, C, L] {
