 ...
 * @param second
 */
case class TransformerChain[A, B, C](first: Transformer[A, B], second: Transformer[B, C]) extends Transformer[A, C] {
 ...
 * @param second
 */
case class TransformerEstimatorChain[A, B, C](first: Transformer[A, B], second: Estimator[B, C])
 ...
 * @param second
 */
case class TransformerLabelEstimatorChain[A, B, C, L](first: Transformer[A, B], second: LabelEstimator[B, C, L])
