  ...
  test("Solve Linear Discriminant Analysis on the Iris Dataset") {
    ...
    val irisRaw =
      """5.1,3.5,1.4,0.2,Iris-setosa
        ...
        |5.9,3.0,5.1,1.8,Iris-virginica""".stripMargin
    val irisData = sc.parallelize(irisRaw.split("\n"))
    ...
    assert(Stats.aboutEq(out.x, new DenseMatrix(4, 2, Array(0.1498, 0.1482, -0.8511, -0.4808, 0.0095, 0.3272, -0.5748, 0.75)), 1E-4))
  }
}
